...
#define RKVDEC_WR_DDR_ALIGN_E				BIT(23)
...
#define RKVDEC_REG_PREF_LUMA_CACHE_ENABLE		0x41C
#define RKVDEC_REG_PREF_CHR_CACHE_COMMAND		0x450
#define RKVDEC_REG_PREF_CHR_CACHE_ENABLE		0x45C
